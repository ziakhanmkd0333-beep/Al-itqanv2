            ...
            >
              <div className="aspect-square rounded-2xl overflow-hidden bg-[var(--primary-soft)] flex items-center justify-center p-8">
                <div className="relative w-full h-full">
                  <Image
                    src="/logo.png"
                    alt={t("about.logoAlt") || "Al-NOOR Academy Logo"}
                    fill
            ...
            <div className={`flex flex-col md:flex-row gap-8 items-center ${isRTL ? "md:flex-row-reverse" : ""}`}>
              ...
              <div className={`text-center md:text-left ${isRTL ? "md:text-right" : ""}`}>
                ...
                <motion.div
                  ...
                  className="mt-6 p-4 rounded-xl bg-gradient-to-r from-[var(--gold)]/10 to-[var(--primary)]/10 border border-[var(--gold)]/30"
                >
                  <p className={`text-[var(--text-primary)] leading-relaxed text-sm md:text-base ${isRTL ? "arabic-text text-right" : "italic"}`}>
                    {t("about.scholar.credentials.scholarlyRecognition")}
                  </p>
                </motion.div>

                <p className={`mt-6 text-[var(--text-secondary)] leading-relaxed ${isRTL ? "arabic-text" : ""}`}>
                  {t("about.scholar.bio")}
                </p>
              </div>
            </div>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="flex items-center justify-center gap-4">
              <p className={`text-[var(--gold)] text-lg font-semibold ${isRTL ? "arabic-text" : ""}`}>
                {t("about.scholar.subtitle")}
              </p>
              <a
                ...
                className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-[#25D366] hover:bg-[#20BA5A] transition-colors duration-200 shadow-lg hover:shadow-xl"
                title="WhatsApp"
              >
                <svg
